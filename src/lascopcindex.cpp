...
int main(int argc, char* argv[])
{
  ...
  // COPC stores each octree node as its own variably-sized LAZ chunk. 
  // Request variable chunking via the 0xFFFFFFFF sentinel.
  laswriteopener.set_chunk_size(U32_MAX);
